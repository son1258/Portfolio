                ...
                <div className="contact__content">
                    ...
                    <div className="contact__info">
                        <div className="contact__card">
                            ...
                            <a href="mailto:dtswork88@gmail.com" className="contact__button">
                                Write me {" "}
                                <i className="bx bx-right-arrow-alt contact__button"></i></a>
                        </div>
                        ...
                        <div className="contact__card">
                            ...
                            <a href="https://www.facebook.com/profile.php?id=100028876574423" className="contact__button" rel="noreferrer">
                                Write me {" "}
                                <i className="bx bx-right-arrow-alt contact__button"></i></a>
                        </div>
                    </div>
